"""Splitting a time series into training and testing folds.

Random k-fold cross validation leaks the future into the past, which flatters a
detector that has really just memorised the shape of an anomaly it was later
tested on. Every mode here slices *positionally* along the time axis, so
training always precedes testing within a fold.
"""
