...
from hazure._core import Transformer, rolling
from hazure._core.window import window_bounds
from hazure.transformers.spec import _is_sequence
...
class RollingAggregate(Transformer):
    ...
    agg
        A name from :data:`hazure.transformers.AGGREGATIONS`, or ``"hist"``.
    agg_params
