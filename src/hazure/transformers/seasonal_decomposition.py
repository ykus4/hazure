...
class SeasonalDecomposition(Transformer):
    ...
    #: The phase anchor and sampling interval the profile was learned against;
    #: the profile is meaningless without them.
    _persisted: ClassVar[tuple[str, ...]] = (*Transformer._persisted, "_datum", "_step")
