...
from hazure._core import Transformer, double_rolling, parse_duration
from hazure.transformers.spec import _is_sequence, _pair
...
class DoubleRollingAggregate(Transformer):
